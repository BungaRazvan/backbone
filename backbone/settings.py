...
BACKUP_ENCRYPTION_PASSPHRASE = env.str("BACKUP_ENCRYPTION_PASSPHRASE", default=None)


BMW_CAR_DATA_CLIENT_ID = env.str("BMW_CAR_DATA_CLIENT_ID", default=None)


BMW_GCID_USERNAME = env.str("BMW_GCID_USERNAME", default=None)
BMW_MQTT_HOST = env.str("BMW_MQTT_HOST", default=None)
BMW_MQTT_TOPIC = f"{BMW_GCID_USERNAME}/{env.str('BMW_CAR_DATA_TOPIC')}"
